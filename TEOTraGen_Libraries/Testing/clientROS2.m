% Crear unos datos en forma de ola (waveform)
% data.x = double(-24);
% data.y = char('c');
%Crear una interfaz de cliente y abrirla

% Humanoid_joints_structure.joints[NUM_JOINTS];
...
Humanoid_joints_structure.support_foot = -1;
