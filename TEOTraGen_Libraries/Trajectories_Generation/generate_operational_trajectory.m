function [traj d_traj dd_traj] = generate_operational_trajectory(traj, d_traj, dd_traj, trajectory_points, total_points, SETTINGS_TEO)
%GENERATE_OPERATIONAL_TRAJECTORY    Generate an operational space trajectory for a humanoid.
%   GENERATE_OPERATIONAL_TRAJECTORY(TRAJ, D_TRAJ, DD_TRAJ, TRAJ_POINTS, TOTAL_POINTS, SETTINGS_TEO) is the smallest element in X. For matrices,
...
%       ZZZ
%
%   See also UNO, DOS, TRES.

%   Copyright (C) 2013-2014, RoboticsLab - University Carlos III of Madrid
