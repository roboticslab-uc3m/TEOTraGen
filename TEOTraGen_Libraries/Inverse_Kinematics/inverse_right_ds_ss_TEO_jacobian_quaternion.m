function [q, dq, ddq] = inverse_right_ds_ss_TEO_jacobian_quaternion(q0, trajectory, d_trajectory, dd_trajectory, h)

%INVERSE_RIGHT_DS_SS_TEO Inverse Differential Kinematics Algorithm usit unit quaternion with right foot as support for the robot TEO
%   [Q, DQ, DDQ] = 
%   INVERSE_RIGHT_DS_SS_TEO_JACOBIAN_QUATERNION(Q0, TRAJECTORY, D_TRAJECTORY, DD_TRAJECTORY, H)
