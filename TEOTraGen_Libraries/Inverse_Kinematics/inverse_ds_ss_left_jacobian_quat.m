function [q, dq, ddq] = inverse_ds_ss_left_jacobian_quat(q0, trajectory, d_trajectory, h)

%INVERSE_LEFT_DS_SS_TEO Inverse Differential Kinematics using Jacobian with unit quaternion algorithm for a humanoid with
...
%        \_| \_\___/|_.__/ \___/ \__|_|\___|___/ \_____/\__,_|_.__/ 
            ...
            %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
            %%%     INVERSE_LEFT_DS_SS_JACOBIAN_QUAT    %%%
            %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
