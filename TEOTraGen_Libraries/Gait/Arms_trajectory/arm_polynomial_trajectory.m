function [arm_traj, darm_traj, ddarm_traj] = arm_polynomial_trajectory(next_footprint, prev_footprint, Ts,  step_times, floating_foot, arm, degree)
...
if strcmp(floating_foot, arm) % Same side than floating foot
  p1_com = next_footprint - next_footprint;
  p5_com = -total_delta;
  ...
  p3_com(3) = p1_com(3) - total_delta(3)/2;
...
[arm_traj, darm_traj, ddarm_traj] = polynomial_trajectory (P, Ts);
